...
function Tecnologias() {
    return(
        <section>
            <aside class="row contratar container-titulo-contratar">
                <div class="container">
                    <div class="row">
            ...
            <article class="row contratar container-nossos-profisionais">
                <div class="container margem-top-container">
                        ...
                        <div class="col-8 col-sm-6 col-md-6 col-lg-3 my-4">
                            <div class="card my-5">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="#" class="btn btn-block cor-secundaria cor-botao-quero-contratar">Quero contratar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-8 col-sm-6 col-md-6 col-lg-3 my-4">
